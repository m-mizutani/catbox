...
function setupLambda(
  ...
  const lambdaRole =
    props.lambdaRoleARN !== undefined
      ? iam.Role.fromRoleArn(stack, "LambdaRole", props.lambdaRoleARN, {
          mutable: false,
        })
      : undefined;
...
function setupWeb(stack: cdk.Stack, apiHandler: lambda.Function) {
  ...
  api.root.addResource("bundle.js").addMethod("GET");
